"A special version of run procedure for continuing from a partial exploration state"
...
with open(
    "results/outputs/pickle/new/Algorithms_20250511_234513/classification_error.pkl",
    "rb",
) as f:
    state = pickle.load(f)
